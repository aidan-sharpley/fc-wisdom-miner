...
from config.settings import (
    OLLAMA_EMBED_MODEL, OLLAMA_BASE_URL, EMBEDDING_BATCH_SIZE,
    EMBEDDING_MAX_RETRIES, EMBEDDING_CACHE_SIZE
)
...
class EmbeddingManager:
    ...
    def get_embeddings(self, texts: Union[str, List[str]], use_cache: bool = True) -> Union[np.ndarray, List[np.ndarray]]:
            ...
            for attempt in range(EMBEDDING_MAX_RETRIES):
                try:
                    ...
                    if attempt < EMBEDDING_MAX_RETRIES - 1:
                        ...
                        logger.error(f"Failed to generate embedding after {EMBEDDING_MAX_RETRIES} attempts")
