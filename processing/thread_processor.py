...
class ThreadProcessor:
    ...
    def process_thread(self, url: str, force_refresh: bool = False) -> Tuple[str, Dict]:
        ...
        try:
            ...
            processing_results = self._save_thread_data(
                thread_dir, processed_posts, scrape_metadata, 
                processing_stats, analytics
            )
            ...
            logger.info(f"Thread processing complete in {processing_time:.2f}s: {len(processed_posts)} posts")
    ...
    def _build_search_index(self, thread_dir: str, posts: List[Dict], embeddings: List) -> HNSWIndex:
    ...
    def _save_thread_data(self, thread_dir: str, posts: List[Dict], 
                         scrape_metadata: Dict, processing_stats: Dict, 
                         analytics: Dict) -> Dict:
