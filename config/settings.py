...
__all__ = [
    ...
    'POST_MAPPING_NAME', 'THREAD_ANALYTICS_NAME', 'CACHE_PATH',
    
    # Performance parameters
    'API_TIMEOUT', 'MAX_RETRIES', 'RETRY_BACKOFF', 'CHUNK_SIZE',
    'CHUNK_OVERLAP', 'QUERY_RERANK_SIZE', 'FINAL_TOP_K', 'MAX_WORKERS',
    
    # HNSW parameters
    'HNSW_M', 'HNSW_EF_CONSTRUCTION', 'HNSW_EF_SEARCH', 'EXPECTED_EMBED_DIM',
    
    # Thread safety
    '_cache_lock', '_file_lock',
    
    # UI and analytics
    'ENABLE_DETAILED_ANALYTICS', 'MAX_PROMPT_LENGTH', 'UI_TIMEOUT_SECONDS',
    
    # Forum scraping
    'POST_SELECTORS', 'CONTENT_SELECTORS', 'AUTHOR_SELECTORS', 'DATE_SELECTORS',
    
    # Query processing
    'ANALYTICAL_QUERY_PATTERNS', 'MIN_INTENT_CONFIDENCE',
